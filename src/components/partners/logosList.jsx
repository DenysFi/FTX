...
const LogosList = () => {
  return (
    <div className="partners__lists">
        ...
        <ul className='partners__list'>
            <li className="partners__item partners__item--deep-dark">
                <div className="partners__icon">
                    <img src='../../../FTX/img/partners/icons/apple.png' loading='lazy' alt=""/>
                </div>
            </li>
            <li className="partners__item partners__item--dark-red">
                <div className="partners__icon">
                    <img src='../../../FTX/img/partners/icons/tesla.png' loading='lazy' alt=""/>
                </div>
            </li>
            <li className="partners__item partners__item--dark">
                <div className="partners__icon">
                    <img src='../../../FTX/img/partners/icons/google.png' loading='lazy' alt=""/>
                </div>
            </li>
            <li className="partners__item partners__item--blue">
                <div className="partners__icon">
                    <img src='../../../FTX/img/partners/icons/microsoft.png' loading='lazy' alt=""/>
                </div>
            </li>
            <li className="partners__item partners__item--red">
                <div className="partners__icon">
                    <img src='../../../FTX/img/partners/icons/coca.png' loading='lazy' alt=""/>
                </div>
            </li>
            <li className="partners__item partners__item--blue">
                <div className="partners__icon">
