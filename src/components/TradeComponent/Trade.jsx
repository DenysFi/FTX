                ...
                <div className="trade__cards">
                    <article className="trade__card card-trade">
                        <div className="card-trade__image">
                            <img src="../../../img/Trade/01.jpg" loading='lazy' alt=""/>
                        </div>
                    ...
                    <article className="trade__card card-trade">
                        <div className="card-trade__image">
                            <img src="../../../img/Trade/02.jpg" loading='lazy' alt=""/>
                        </div>
                    ...
                    <article className="trade__card card-trade">
                        <div className="card-trade__image">
                            <img src="../../../img/Trade/03.jpg" loading='lazy' alt=""/>
                        </div>
                    ...
                    <article className="trade__card card-trade">
                        <div className="card-trade__image">
                            <img src="../../../img/Trade/04.jpg" loading='lazy' alt=""/>
                        </div>
                    ...
                    <article className="trade__card card-trade">
                        <div className="card-trade__image">
                            <img src="../../../img/Trade/05.jpg" loading='lazy' alt=""/>
                        </div>
                    ...
                    <article className="trade__card card-trade">
                        <div className="card-trade__image">
                            <img src="../../../img/Trade/06.jpg" loading='lazy' alt=""/>
                        </div>
