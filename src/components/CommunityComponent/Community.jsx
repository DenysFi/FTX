            ...
            <div className="community__content">
                ...
                <div className="community__labels">
                    <div  className="community__label label-community">
                        <img  className="label-community__icon" src='../../../img/common/card-offer/label-ico/01.svg' loading='lazy' alt="icon"/>
                        <div className="label-community__text">Feature 1</div>
                    </div>
                    <div  className="community__label label-community">
                        <img  className="label-community__icon" src='../../../img/common/card-offer/label-ico/02.svg' loading='lazy' alt="icon"/>
                        <div className="label-community__text">Feature 2</div>
                    </div>
                    <div  className="community__label label-community">
                        <img  className="label-community__icon" src='../../../img/common/card-offer/label-ico/03.svg' loading='lazy' alt="icon"/>
                        <div className="label-community__text">Feature 3</div>
                    </div>
                </div>
                {isMoveble && <div  className="community__image">
                <img src="../../../img/Community/img.png" loading='lazy' alt="icon"/>
            </div>}
