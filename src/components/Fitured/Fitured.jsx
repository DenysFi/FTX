        ...
        <div className="fitured__container">
            ...
            <div className="fitured__images">
                <a href='##' className="fitured__image">
                    <img src="../../../FTX/img/fitured/01.svg" loading='lazy' alt="icon" />
                </a>
                <a href='##' className="fitured__image">
                    <img src="../../../FTX/img/fitured/02.svg" loading='lazy' alt="icon" />
                </a>
                <a href='##' className="fitured__image">
                    <img src="../../../FTX/img/fitured/03.svg" loading='lazy' alt="icon" />
                </a>
                <a href='##' className="fitured__image">
                    <img src="../../../FTX/img/fitured/04.svg" loading='lazy' alt="icon" />
                </a>
                <a href='##' className="fitured__image">
                    <img src="../../../FTX/img/fitured/05.svg" loading='lazy' alt="icon" />
                </a>
            </div>
